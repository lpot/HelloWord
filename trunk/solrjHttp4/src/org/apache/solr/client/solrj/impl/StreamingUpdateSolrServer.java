      ...
      try {
        ...
        do {
          try {
            ...
            method = new HttpPost(_baseURL+updateUrl );

            method.addHeader( "User-Agent", AGENT );
            
            oHttpResponse = getHttpClient().execute(method);
            
            //Get hold of the response entity
            
            int statusCode = oHttpResponse.getStatusLine().getStatusCode();
            //int statusCode = getHttpClient().executeMethod(method);
            if (statusCode != HttpStatus.SC_OK) {
              StringBuilder msg = new StringBuilder();
              msg.append( oHttpResponse.getStatusLine().getReasonPhrase());
              msg.append( "\n\n" );
              msg.append( oHttpResponse.getStatusLine());
              msg.append( "\n\n" );
              ...
              if(oHttpResponse != null) {
                  entity = oHttpResponse.getEntity();
              }
              if (entity != null) {
